...
func (h *Handlers) ContractDetail(w http.ResponseWriter, r *http.Request) {
	data := pages.ContractDetailData{
		...
		Functions: []pages.ContractFunction{
			{Name: "swap", Calls: "142,847", Pct: "50.3%", AvgCPU: "24.2M insn", LastCalled: "2 min ago"},
			{Name: "add_liquidity", Calls: "48,201", Pct: "17.0%", AvgCPU: "18.4M insn", LastCalled: "8 min ago"},
			{Name: "remove_liquidity", Calls: "32,104", Pct: "11.3%", AvgCPU: "16.8M insn", LastCalled: "22 min ago"},
			{Name: "get_reserves", Calls: "28,421", Pct: "10.0%", AvgCPU: "2.1M insn", LastCalled: "30s ago"},
			{Name: "initialize", Calls: "1", Pct: "0.0%", AvgCPU: "42.8M insn", LastCalled: "Jan 15, 2024"},
		},
		Invocations: []pages.ContractInvocation{
			{TxHash: "8f2a1b4c5d6e7f8a", ShortHash: "8f2a...1b4c", Function: "swap", Caller: "GABC...7X92", Status: "Success", Age: "2 min ago"},
			{TxHash: "c4e93d7f2a1b8e5a", ShortHash: "c4e9...3d7f", Function: "add_liquidity", Caller: "GDEF...9R23", Status: "Success", Age: "8 min ago"},
			{TxHash: "a1b28e5a9f7d2c4e", ShortHash: "a1b2...8e5a", Function: "swap", Caller: "GHIJ...2M56", Status: "Success", Age: "15 min ago"},
			{TxHash: "f7d24c9b3a8e1f2d", ShortHash: "f7d2...4c9b", Function: "remove_liquidity", Caller: "GKLM...1V48", Status: "Success", Age: "22 min ago"},
		},
